...
1. Create a new branch with the following name:
   ...
   <img width="250" alt="image" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/create-branch.png?raw=true" />
...
1. In the top right, click the **Add file** button and select **Create new file**.
   ...
   <img width="250" alt="image" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/add-file-button.png?raw=true" />
...
1. Set the file name to:
   ...
   <img width="650" alt="image" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/new-file-name.png?raw=true" />
