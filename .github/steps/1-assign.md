...
<img width="600" alt="screenshot of Mergington High School WebApp" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/mergington-webapp-screenshot.png?raw=true" />
...
1. Validate the **GitHub Copilot** and **Python** extensions are installed and enabled.
   ...
   <img width="300" alt="copilot extension for VS Code" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/copilot-vscode-extension.png?raw=true" /><br/>
   <img width="300" alt="python extension for VS Code" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/python-vscode-extension.png?raw=true" />
...
1. Try running the application. In the left sidebar, select the **Run and Debug** tab and then press the **Start Debugging** icon.
   ...
   <img width="300" alt="run and debug" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/run-and-debug.png?raw=true" />
   ...
   <img width="300" alt="empty run and debug panel" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/empty-run-and-debug-panel.png?raw=true" />
...
1. Use the **Ports** tab to find the webpage address, open it, and verify it is running.
   ...
   <img width="350" alt="ports tab" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/ports-tab.png?raw=true" />
...
1. In the top right, click your **user icon** and select **Settings**.
   ...
   <img width="200" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/user-icon-menu.png?raw=true"><br/>
   <img width="200" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/settings-copilot-menu.png?raw=true">

1. In the left navigation, expand the **Copilot** section and select **Cloud agent**.

   <img width="200" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/copilot-cloud-agent-settings.png?raw=true">
...
1. Check that the **Repository access** field is set to `All repositories`.
   ...
   <img width="300" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/copilot-repository-access.png?raw=true">
...
1. In the top right, click on the **Assignees** area and select **Copilot**.
   ...
   <img width="350" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/issue-assignees-copilot.png?raw=true" />
...
1. A dialog **might** appear describing that Copilot will begin work. Click the **Assign** button, ignoring the option to provide additional details.
   ...
   <img width="350" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/assign-copilot-window.png?raw=true" />
...
1. After you assign the issue to Copilot, in a moment, you will notice:
   ...
   <img width="400" src="https://github.com/aj6k/skills-expand-your-team-with-copilot/blob/main/.github/images/issue-copilot-assigned.png?raw=true" />
